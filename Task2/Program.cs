        ...
        private static void Menu()
        {
            ...
            switch (menuItem)
            {
                case "1":
                    ...
                    result = Calculator.Addition(firstValue, secondValue);
                    Console.WriteLine($"Sum of A={firstValue} and B={secondValue} equals to {result}");
                    break;
                case "2":
                    Console.WriteLine("Input parameters for calculating:\n");
                    InputTwoParametrs(out firstValue, out secondValue);
                    result = Calculator.Subtraction(firstValue, secondValue);
                ...
                case "4":
                    Console.WriteLine("Input parameters for calculating:\n");
                    InputTwoParametrs(out firstValue, out secondValue);
                    result = Calculator.Division(firstValue, secondValue);
